  ...
  return (
    <div className="app">
      ...
      <main className="main-content">
        ...
        {activeSection === 'courses' && <CoursesSection items={courses} onDelete={deleteEntry} onPreview={setPreviewImage} setFormOpen={() => { setFormType('course'); setIsFormOpen(true); }} />}
      </main>
...
// Courses Section
function CoursesSection({ items, onDelete, onPreview, setFormOpen }) {
  return (
    <div className="section">
      <div className="section-header">
        <div>
